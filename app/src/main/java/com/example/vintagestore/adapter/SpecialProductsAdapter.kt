...
import com.example.vintagestore.databinding.SpecialRvItemsBinding
...
class SpecialProductsAdapter : RecyclerView.Adapter<SpecialProductsAdapter.SpecialProductViewHolder>() {
    ...
    inner class SpecialProductViewHolder(
        private val binding: SpecialRvItemsBinding):RecyclerView.ViewHolder(binding.root){
